...
class GamingSession(Base):
    ...
    worker_id: Mapped[Optional[int]] = mapped_column(ForeignKey("workers.id"), nullable=True, index=True)
    ...
    worker: Mapped[Optional["Worker"]] = relationship(back_populates="sessions")
