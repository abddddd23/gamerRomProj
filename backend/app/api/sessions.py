...
from app.auth.dependencies import get_current_user_optional, require_worker_or_admin
...
def start_session(
    ...
    current_user: Worker | None = Depends(get_current_user_optional),
):
...
def list_session_history(
    ...
    return session_service.session_history(db, start_date, end_date, worker_id, post_id, game_id, offset, min(limit, 200))
